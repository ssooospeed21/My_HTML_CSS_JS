...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $db->prepare("INSERT INTO orders (user_id, full_name, phone, email, address, workplace, position, work_phone, has_business_card, visid) VALUES (:user_id, :full_name, :phone, :email, :address, :workplace, :position, :work_phone, :has_business_card, 2)");
